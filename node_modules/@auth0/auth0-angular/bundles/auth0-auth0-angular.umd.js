(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var useragent = { name: '@auth0/auth0-angular', version: '1.2.0' };
    ...
    var AuthService = /** @class */ (function () {
        function AuthService(auth0Client, location, navigator) {
             ...
             */
            this.idTokenClaims$ = this.isAuthenticated$.pipe(operators.filter(function (authenticated) { return authenticated; }), operators.distinctUntilChanged(), operators.concatMap(function () { return _this.auth0Client.getIdTokenClaims(); }));
            /**
    ...
    var AuthHttpInterceptor = /** @class */ (function () {
        function AuthHttpInterceptor(configFactory, auth0Client) {
        ...
        AuthHttpInterceptor.prototype.intercept = function (req, next) {
            ...
            return this.findMatchingRoute(req, config).pipe(operators.concatMap(function (route) { return rxjs.iif(
        ...
        AuthHttpInterceptor.prototype.findMatchingRoute = function (request, config) {
            var _this = this;
            return rxjs.from(config.httpInterceptor.allowedList).pipe(operators.first(function (route) { return _this.canAttachToken(route, request); }, null));
        };
